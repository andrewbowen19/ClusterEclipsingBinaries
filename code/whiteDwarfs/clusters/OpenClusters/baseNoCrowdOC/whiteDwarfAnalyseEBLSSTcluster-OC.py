...
# Baseline OC analyse script -- NO crowding
...
if __name__ == "__main__":
	...
	d = "/projects/p30137/ageller/testing/EBLSST/clusters/OpenClusters/output_files/"
	files = os.listdir(d)
	IDs = []
	...
	WDall.to_csv('./data/wd/all-OBN-WD-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i', 'appMagMean_r'])
	WDobs.to_csv('./data/wd/obs-OBN-WD-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i', 'appMagMean_r'])
	WDrec.to_csv('./data/wd/rec-OBN-WD-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i', 'appMagMean_r'])
