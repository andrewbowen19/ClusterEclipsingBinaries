...
def saveHist(histAll, histObs, histRec, bin_edges, xtitle, fname):
	...
	ax1.set_ylabel('PDF')
	ax1.set_yscale('log')
	ax1.legend(loc = 'lower center')#setting legend for plots
	#CDF
	cdfAll = []
	cdfObs = []
	cdfRec = []
	...
	f.savefig('/Users/andrewbowen/ceb_project/plots/clusterPlots/' + fname + '.pdf',format='pdf', bbox_inches = 'tight')

	#write to a text file
	with open('/Users/andrewbowen/ceb_project/data/ebFiles/'+fname+'.csv','w') as f:
...
if __name__ == "__main__":
	...
	d = "/Users/andrewbowen/ceb_project/data/ebFiles/"
	files = os.listdir(d)
	IDs = []
