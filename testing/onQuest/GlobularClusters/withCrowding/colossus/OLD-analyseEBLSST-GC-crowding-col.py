...
# OLD - does not make csv files for 2d hist plots
...
if __name__ == "__main__":
	...
	peccAll.to_csv('./pecc/all-GCC-ecc-p.csv', header = ['e', 'p'])
	peccObs.to_csv('./pecc/obs-GCC-ecc-p.csv', header = ['e', 'p'])
	peccRec.to_csv('./pecc/rec-GCC-ecc-p.csv', header = ['e', 'p'])
