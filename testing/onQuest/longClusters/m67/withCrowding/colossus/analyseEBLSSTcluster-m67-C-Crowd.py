...
# Colossus M67 script -- WITH crowding
...
if __name__ == "__main__":
	...
	peccAll.to_csv(os.path.join('.', 'pecc', 'all-M67CC-ecc-p.csv'), header = ['e', 'p'])
	peccObs.to_csv(os.path.join('.', 'pecc', 'obs-M67CC-ecc-p.csv'), header = ['e', 'p'])
	peccRec.to_csv(os.path.join('.', 'pecc', 'rec-M67CC-ecc-p.csv'), header = ['e', 'p'])
