...
# M67 version of code (does the same thing as original, just in a different directory tree)
...
#dat = pd.read_csv('./data/all-M10BN.csv')
#print(dat)
#print('########################################')
...
for root, dirs, files in os.walk('.', topdown = True):
	...
	for name in files:
		...
		if '-histData.csv' in name:
			...
			# Making corner plots for everything
