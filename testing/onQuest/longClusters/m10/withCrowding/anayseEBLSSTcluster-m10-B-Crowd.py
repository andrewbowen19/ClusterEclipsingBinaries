...
# Baseline M10 script -- WITH crowding
...
if __name__ == "__main__":
	...
	peccAll.to_csv(os.path.join('.', 'pecc', 'all-M10BC-ecc-p.csv'), header = ['e', 'p'])
	peccObs.to_csv(os.path.join('.', 'pecc', 'obs-M10BC-ecc-p.csv'), header = ['e', 'p'])
	peccRec.to_csv(os.path.join('.', 'pecc', 'rec-M10BC-ecc-p.csv'), header = ['e', 'p'])
