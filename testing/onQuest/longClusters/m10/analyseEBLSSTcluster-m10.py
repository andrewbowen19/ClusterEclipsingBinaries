...
# Baseline M10 script -- NO crowding
...
if __name__ == "__main__":
	...
	peccAll.to_csv(os.path.join('.', 'pecc', 'all-M10BN-ecc-p.csv'), header = ['e', 'p'])
	peccObs.to_csv(os.path.join('.', 'pecc', 'obs-M10BN-ecc-p.csv'), header = ['e', 'p'])
	peccRec.to_csv(os.path.join('.', 'pecc', 'rec-M10BN-ecc-p.csv'), header = ['e', 'p'])
