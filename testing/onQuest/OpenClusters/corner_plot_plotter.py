# Corner plot script 
# Open Cluster version, need to add to other file trees (M67, OC, GC)
...
def corner_plot(DataFrame, popType, name, contours = False):
	...
	# No contours
		...
		# df.columns = ['log-p', 'm1 $(M_{\odot})$', 'm2 $(M_{\odot})$', 'r1 $(R_{\odot})$', 'r2 $(R_{\odot})$', 'e', 'i (deg)'] # Renaming column labels
