...
# Colossus OC script -- WITH crowding
...
if __name__ == "__main__":
	...
	peccAll.to_csv(os.path.join('.', 'pecc', 'all-OCC-ecc-p.csv'), header = ['e', 'p'])
	peccObs.to_csv(os.path.join('.', 'pecc', 'obs-OCC-ecc-p.csv'), header = ['e', 'p'])
	peccRec.to_csv(os.path.join('.', 'pecc', 'rec-OCC-ecc-p.csv'), header = ['e', 'p'])
