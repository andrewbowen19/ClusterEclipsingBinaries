...
# Colossus GC long script -- WITH crowding
...
if __name__ == "__main__":
	...
	d = "/projects/p30137/ageller/testing/EBLSST/clusters/GlobularClusters/withCrowding/colossus/output_files/"
	files = os.listdir(d)
	IDs = []
	...
	All.to_csv('./data/all-GCC-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i', 'appMagMean_r'])
	Obs.to_csv('./data/obs-GCC-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i', 'appMagMean_r'])
	Rec.to_csv('./data/rec-GCC-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i', 'appMagMean_r'])
	...
	WDall.to_csv('./data/wd/all-GCC-WD-LISA-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i', 'appMagMean_r'])
	WDobs.to_csv('./data/wd/obs-GCC-WD-LISA-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i', 'appMagMean_r'])
	WDrec.to_csv('./data/wd/rec-GCC-WD-LISA-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i', 'appMagMean_r'])
