...
if __name__ == "__main__":
	...
	WDall.to_csv('./data/wd/all-M67CC-WD-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i', 'appMagMean_r'])
	WDobs.to_csv('./data/wd/obs-M67CC-WD-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i', 'appMagMean_r'])
	WDrec.to_csv('./data/wd/rec-M67CC-WD-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i', 'appMagMean_r'])
