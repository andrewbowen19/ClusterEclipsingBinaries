...
if __name__ == "__main__":
	...
	All.to_csv('./data/all-M67CN-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i'])
	Obs.to_csv('./data/obs-M67CN-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i'])
	Rec.to_csv('./data/rec-M67CN-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i'])
