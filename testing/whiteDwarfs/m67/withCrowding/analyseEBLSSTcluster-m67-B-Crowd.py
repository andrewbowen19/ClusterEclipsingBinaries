...
def saveHist(histAll, histObs, histRec, bin_edges, xtitle, fname, filters = ['u_', 'g_', 'r_', 'i_', 'z_', 'y_','all']):
	...
	ax1.set_ylabel('PDF')
	ax1.set_yscale('log')
	ax1.set_title('M67 - Baseline (with Crowding)', fontsize = 16)
...
if __name__ == "__main__":
	...
	All.to_csv('./data/all-M67BC-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i'])
	Obs.to_csv('./data/obs-M67BC-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i'])
	Rec.to_csv('./data/rec-M67BC-histData.csv', header = ['p', 'm1', 'm2', 'r1', 'r2', 'e', 'i'])
