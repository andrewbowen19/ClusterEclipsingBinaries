...
\keywords{Vera Rubin Observatory -- LSST -- eclipsing binaries}
...
\begin{figure*}[p]
    ...
    \caption{Globular Cluster-\textit{baseline} corner plots for the \textit{observable} sub-population. The binary parameters pictures are the same as those listed above in Figure \ref{fig:gbc-hists}.} %Figure~\ref{fig:gbc-Obs-corner-plot}.}
